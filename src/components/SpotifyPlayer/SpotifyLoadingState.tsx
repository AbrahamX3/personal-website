const LoadingState = () => {
  return (
    <div className="flex justify-center flex-row space-x-2 w-full h-28 align-middle items-center rounded-lg shadow-md cursor-pointer bg-transparent border-2 border-white/30 backdrop-blur-md p-2">
      <svg
